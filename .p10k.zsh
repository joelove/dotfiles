# Generated by Powerlevel10k configuration wizard on 2024-04-05 at 12:12 BST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49778.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, slanted separators, round heads, slanted tails, 2 lines, solid, left frame,
...
() {
  ...
  #####################################[ swap: used swap ]######################################
  # Swap color.
  typeset -g POWERLEVEL9K_SWAP_FOREGROUND=6
  typeset -g POWERLEVEL9K_SWAP_BACKGROUND=239
  # Custom icon.
